  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4" data-testid="nav-popup-overlay">
      ...
      >
        ...
        <div>
          <h3 className="text-xl font-bold text-[#1A1A4E]" style={{ fontFamily: "Outfit, sans-serif" }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Select value={product} onValueChange={setProduct}>
                <SelectTrigger data-testid="nav-popup-product" className="bg-white border-gray-200 focus:border-[#0088CC] focus:ring-4 focus:ring-[#0088CC]/10 rounded-xl h-12 px-4">
